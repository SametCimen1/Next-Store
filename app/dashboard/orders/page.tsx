...
import { orders, ordersRelations } from '@/server/schema';
...
export default async function Page(){
  ...
  const useOrders = await db.query.orders.findMany({
                            ...
                            <TableBody>
                              {order.orderProduct.map(({product, productVariants, quantity}) => (
                                  <TableRow key = {product.id}>
                                    <TableCell>
                                      <Image src = {productVariants.variantImages[0].url} width={48} height={48} alt = {product.title}/>
                                    </TableCell>
                                    ...
                                    <TableCell className='text-medium'>{quantity}</TableCell>
                                  </TableRow>
                                ))}
                            </TableBody>
                            </Table>
