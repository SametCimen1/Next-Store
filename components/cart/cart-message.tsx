    ...
    return(
        <motion.div className=" text-center" animate={{opacity:1, x:0}} initial={{opacity:0, x:10}}>
            ...
            <DrawerDescription className="py-1">
                ...
                {checkoutProgress === 'payment-page' ? <span onClick={() => setCheckoutProgress('cart-page')} className="flex items-center justify-center gap-1 cursor-pointer hover:text-primary"><ArrowLeft size={14}/>Head Back to Cart </span> : null}
